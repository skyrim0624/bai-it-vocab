...
> 这是基于掰 it v0.2.5 的非官方个人学习改造版，新增了点词加入生词本、发音、读句测验和学习建议功能。原项目许可证为 BSL 1.1，本仓库仅用于非商业学习分享，不是官方版本，也不要作为产品或服务分发。
...
这个改造版还支持直接点击网页里的任意英文单词，自动选中整个词，显示中文释义、发音按钮，并可一键加入生词本。
...
- **生词本**：管理生词、语境、掌握状态；根据生词生成读句测验，并生成可复制给 Codex 的学习建议上下文
- **设置**：配 API key、调拆分力度
...
1. 到 [Releases](https://github.com/skyrim0624/bai-it-vocab/releases) 页面下载最新的 `bai-it-vX.X.X-vocab.zip`（⚠️ 不要下载 "Source code"，那是源码，无法直接安装）
2. **解压** zip 文件到一个文件夹
...
欢迎通过 [Issue](https://github.com/skyrim0624/bai-it-vocab/issues) 提建议和反馈 bug。本改造版仅做个人学习分享。
